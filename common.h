...
namespace wxn
{
    namespace largefile
    {
        ...
        struct BlockInfo
        {
            ...
            {
                // 所有的成员都相等,则两个块相等
                return block_id_ == rhs.block_id_ && version_ == rhs.version_ && file_count_ == rhs.file_count_ && size_t_ == rhs.size_t_ && del_file_count_ == rhs.del_file_count_ && seq_no_ == rhs.seq_no_;
            }
        };
